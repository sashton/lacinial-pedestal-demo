...
(def service
  (lacinia/service-map hello-schema {:routes (route/expand-routes
                                              (into (lacinia/graphql-routes hello-schema nil)
                                                    [["/ping" :get ping-handler :route-name ::ping]
                                                     ["/pong" :get pong-interceptor :route-name ::pong]]))}))
